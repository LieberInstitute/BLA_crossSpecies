...
Amy.Excit.700 <- readRDS(here(processed_dir, "00_costa_rds", "All5CN700exciteClusters.rds"))
Amy.Excit.700
sce.costa.excit <- as.SingleCellExperiment(Amy.Excit.700)
# An object of class Seurat 
# 21353 features across 38547 samples within 2 assays 
# Active assay: integrated (2000 features, 2000 variable features)
# 1 other assay present: RNA
# 2 dimensional reductions calculated: pca, umap

Amy.Inhib.700 <- readRDS(here(processed_dir, "00_costa_rds", "All5CN700inhibitClusters.rds"))
Amy.Inhib.700
sce.costa.inhib <- as.SingleCellExperiment(Amy.Inhib.700)
...
common_genes <- intersect(rownames(sce.totty), rownames(sce.costa.inhib))
sce.totty <- sce.totty[common_genes,]
sce.costa.inhib <- sce.costa.inhib[common_genes, ]

new_colData = data.frame(
  study_id = rep(c('costa.inhib', 'Totty'), c(ncol(sce.costa.inhib), ncol(sce.totty))),
  cell_type = c(as.character(colData(sce.costa.inhib)$ident), colData(sce.totty)$annotation)
)
sce.bla <- SingleCellExperiment(
  Matrix(cbind(assay(sce.costa.inhib, 1), assay(sce.totty, 1)), sparse = TRUE),
  colData = new_colData
)
dim(sce.bla)
rm(sce.totty); rm(sce.costa.inhib)
...
# 1     costa.inhib|PVALB ADAMTS5         Totty|Inh_5       1.00 Reciprocal_top_hit
# 2     costa.inhib|LAMP5 COL14A1   Totty|Inh_LAMP5_2       1.00 Reciprocal_top_hit
# 3        costa.inhib|HTR3A DRD2         Totty|Inh_4       1.00 Reciprocal_top_hit
# 4        costa.inhib|LAMP5 NDNF   Totty|Inh_LAMP5_1       1.00 Reciprocal_top_hit
# 5      costa.inhib|TSHZ1 SEMA3C     Totty|Inh_ITC_2       0.99 Reciprocal_top_hit
# 6      costa.inhib|TSHZ1 CALCRL     Totty|Inh_ITC_1       0.98 Reciprocal_top_hit
# 7          costa.inhib|VIP NDNF         Totty|Inh_2       0.98 Reciprocal_top_hit
# 8          costa.inhib|SST EPYC       Totty|Inh_SST       0.98 Reciprocal_top_hit
# 9           costa.inhib|SST HGF     Totty|Inh_PVALB       0.98 Reciprocal_top_hit
# 10         costa.inhib|VIP NDNF         Totty|Inh_1       0.98          Above_0.9
# 11       costa.inhib|VIP ABI3BP     Totty|Inh_VIP_1       0.98 Reciprocal_top_hit
# 12       costa.inhib|VIP ABI3BP     Totty|Inh_VIP_2       0.95          Above_0.9
# 13       costa.inhib|VIP ABI3BP         Totty|Inh_3       0.92          Above_0.9
