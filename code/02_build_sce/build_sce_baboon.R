...
gtf <-
    rtracklayer::import(
        "/dcs04/lieber/marmaypag/BLA_crossSpecies_LIBD1070/BLA_crossSpecies/raw-data/refdata/Panubis1_genome/genes/genes.gtf"
    )
...
save(sce, file = here("processed-data",  "02_build_sce", "sce_baboon_raw.rda"))
