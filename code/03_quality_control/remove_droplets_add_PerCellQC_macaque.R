...
names(knee_lower) <- c(
  ...
  "VC_snRNAseq_12_Animal5_Accessory_Basal__AP2_AP3",
  "VC_snRNAseq_12_Animal5_Basal__AP1",
  "VC_snRNAseq_12_Animal5_Basal__AP2",
  "VC_snRNAseq_12_Animal5_Lateral__AP1",
...
pd <- colData(sce) %>% as.data.frame()
sample_info <- pd %>%
  group_by(Sample, brain, sort, round) %>%
  summarize(
