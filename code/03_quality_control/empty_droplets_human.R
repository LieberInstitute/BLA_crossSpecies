...
for (sample_run in unique_samples) {
    ...
    if (!dir.exists(here("processed-data","Human", "03_quality_control", "droplet_scores"))) dir.create(here("processed-data", "Human", "03_quality_control", "droplet_scores"))
    save(e.out, file = here("processed-data", "Human", "03_quality_control", "droplet_scores", paste0("droplet_scores_", sample_run, ".Rdata")))
    ...
    ggsave(droplet_elbow_plot, filename = here("plots","Human", "03_quality_control", "droplet_scores", paste0("droplet_qc_", sample_run, ".png")))
}
