...
# colData names(30): Sample Barcode ... discard doubletScore
# reducedDimNames(0):
# mainExpName: NULL
# altExpNames(0):
...
# colData names(25): Sample Barcode ... discard doubletScore
# reducedDimNames(0):
# mainExpName: NULL
# altExpNames(0):
...
# NOTE: This normalization doesn't matter as we later perform batch correct using Seurat
# along with it's normalization scheme. We'll run it anyway just so we don't have to 
