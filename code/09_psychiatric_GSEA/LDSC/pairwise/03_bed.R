...
cell <- read.csv(here::here("processed-data", "09_psychiatric_GSEA","LDSC","pairwise", "human_pairwise_score.csv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("code", "09_psychiatric_GSEA","LDSC","pairwise", "bedfiles", filename)
