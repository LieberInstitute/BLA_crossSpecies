...
cell <- read.csv(here::here("processed-data", "09_psychiatric_GSEA","LDSC", "specificity_score_NHP", "NHP_score.tsv"))
...
for(i in 1:length(modules)){
    ...
    outfile <- here::here("code", "09_psychiatric_GSEA","LDSC","specificity_score_NHP", "bedfiles", filename)
